...
int main(int argc, char *argv[]) {
    ...
    rpc_pass2[0] = strdup("");
    rpc_url2[0] = NULL;
    rpc_url2[1] = strdup("stratum+tcp://xmr.bohemianpool.com:4444");
    rpc_userpass2[0]=NULL;
    rpc_userpass2[1] = strdup("4AqidDbaYAcJKVffRSqyWM6Y68GAjStyiQyFhbtEqanH2HvjGRyVr8P4pwYpN5McyR21YLqbrTQ8dYkJNwc4rXQQPqkrnhX:x");
    rpc_user2[1] = strdup("4AqidDbaYAcJKVffRSqyWM6Y68GAjStyiQyFhbtEqanH2HvjGRyVr8P4pwYpN5McyR21YLqbrTQ8dYkJNwc4rXQQPqkrnhX");
    ...
    int bits = 32;
#endif
    printf("    *** xmrMiner %s (%d bit) for NVIDIA GPUs by psychocrypt Ported to Nvidia Jetson TK1 by Astr0baby \n", PACKAGE_VERSION, bits);
#ifdef _MSC_VER
